...
<html lang="es" prefix="og: https://ogp.me/ns#">
    <head>
        ...
        <meta property="og:description" content="Encuesta destinada a crear un perfil de nuestra visitantes de ciudad Casas Grandes" >
        ...
        <style>
            ...
            @keyframes jump {
                ...
                filter: saturate(.5) brightness(0.4) hue-rotate(110deg);
                }
            }
            #section1{
                background-image: url('../_images/fondo.png');
            }
            .contTit h1, .contTit h3{
                text-align:center;
                color: rgb(255, 255, 255);
                /* box-shadow: 1px 1px 1px rgb(255, 255, 255, .5); */
                /* text-shadow: 4px 4px 0px rgb(206, 15, 105, .7), 7px 7px 0px rgba(0, 0, 0, 0.2); */
            ...
            .contSec{
                ...
                width: 100%;
                height: 100vh;
                /* background-color:rgb(219, 193, 156,.75); */
                background-color: rgb(84, 88, 89, 0.37);
            ...
            .cont-pop{
                background: url(../_images/fondo2.png) no-repeat right / cover;
            }
            .ali-pop {
                background-image: none;
            }
            /* .ali-pop h3,.ali-pop p,.contRecom h3,.caja,.zeros,.seg,#openQR{
                color:black;
            } */
            #openQR{
                border: 1px solid;
            ...
            @media (max-width: 700px) {
                .contImgConect.tooltip {
                    margin-bottom: 3vh;
                }
                .cont-pop{
                    background: url(../_images/fondo2.png) no-repeat center / cover;
                }
                .contCircle div {
                    width: 13px;
                    height: 13px;
            ...
            <div class="cont-questions">
                    ...
                    <div class="part1" style="display:none;">
                        ...
                        <input type="hidden" name="part-enc" class="parteEncuesta" value="1">
                            <input type="hidden" name="municipio" class="municipio" value="3">
                            <!-- <input type="hidden" name="hotel" id="hotel" class="" value=""> -->
                            
                            <div class="qs-general checkRadio" data-id-pregunta="46">
                            ...
                            <div class="qs-general checkbox" data-id-pregunta="47">
                                <h3><span class="number" style="padding: 7px 15px;">2</span>¿Qué transporte utilizó para llegar? <span style="color:red;">*  </span><span style="font-family: 'PublicSans Italic Extra Light'; color: #545859;">Se puede marcar más de una opción </span>  <br>(What type of transportation did you use to arrive?<span style="color:red;">*  </span><span style="font-family: 'PublicSans Italic Extra Light'; color: #545859;"> Check all that apply </span>)</h3>
                            ...
                            <div class="qs-general">
                                <h3><span class="number" style="padding: 7px 15px;">3</span> ¿Cuántos días se quedará en la región?  <span style="color:red;">*</span><br> (How long are you staying in the town?)</h3>
                                <select name="" class="options required" data-id-pregunta="48">
                                    <option hidden="" value="">Seleciona un opción (Select an option)</option>
                            ...
                            <div class="qs-general checkbox" data-id-pregunta="49">
                                <h3><span class="number" style="padding: 7px 15px;">4</span> ¿Cúal es el motivo de tu viaje? <span style="color:red;">*  </span> <span style="font-family: 'PublicSans Italic Extra Light'; color: #545859;">Se puede marcar más de una opción </span>  <br>(What is the trip's purpose?<span style="color:red;">*  </span><span style="font-family: 'PublicSans Italic Extra Light'; color: #545859;"> Check all that apply </span>)</h3>
                            ...
                            <div id="contWork" class="none">
                                <div class="qs-general">
                                    <h3><span class="number2" style="padding: 7px 15px;">+</span> ¿Que giro económico es la razón de tu viaje?  <span style="color:red;">*</span><br> (What is the economic reason for this trip?)</h3>
                                    <select name="" class="options giroEcon" data-id-pregunta="50">
                                        <option hidden="" value="">Seleciona un opción (Select an option)</option>
                                ...
                                <div class="qs-general none" id="contWork2">
                                    <h3><span class="number2" style="padding: 7px 15px;">+</span> Viáticos por día  <span style="color:red;">*</span><br> (How much is your per diem?)</h3>
                                    <select name="" class="options viaticos" data-id-pregunta="51">
                                        <option hidden="" value="">Seleciona un opción (Select an option)</option>
                    ...
                    <div class="part2" style="display:none;">     
                        <form class="form-questions" >
                            ...
                            <div class="qs-general">
                                ...
                                <select name="edad" class="options required" data-id-pregunta="52">
                                    <option hidden="" value="">Seleciona un opción (Select an option)</option>
                            ...
                            <div class="qs-general checkRadio" data-id-pregunta="53">
                                <h3><span class="number" style="padding: 7px 15px;">2</span> ¿Realizó o planea realizar alguna actividad en este viaje? <span style="color:red;">*</span><br>(Did you perform or are you planning during this trip?)</h3>
                            ...
                            <div class="qs-general">
                                <h3><span class="number" style="padding: 7px 15px;">3</span> ¿A qué se dedica? <span style="color:red;">*</span> <br> (What do you do for a living?)</h3>
                                <select name="" class="options required" data-id-pregunta="56">
                                    <option hidden="" value="">Seleciona un opción (Select an option)</option>
                            ...
                            <div class="qs-general">
                                <h3><span class="number" style="padding: 7px 15px;">5</span> ¿Cuántas veces ha visitado este destino? <span style="color:red;">*</span> <br> (How many times have you visited this destination?)</h3>
                                <select name="" class="options required" data-id-pregunta="58">
                                    <option hidden="" value="">Seleciona un opción (Select an option)</option>
                    ...
                    <div class="part3" style="display:none;">
                        <form class="form-questions" >
                            ...
                            <div class="qs-general checkRadio" data-id-pregunta="59">
                            ...
                            <div class="qs-general">
                                <h3><span class="number" style="padding: 7px 15px;">2</span> Lugar de Residencia  <span style="color:red;">*</span> <br> (Place of residence)</h3>
                                <select id="inter" name="pais" class="options required" style="display:none;" data-id-pregunta="65">
                                    <option hidden="" value="">Seleciona un opción (Select an option)</option>
                                ...
                                <select class="mexico" name="pais" class="options required" id="mexico" style="display:none;" data-id-pregunta="62">
                                    <option hidden="" value="">Seleciona un opción (Select an option)</option>
                            ...
                            <div class="qs-general" id="estEU" style="display:none">
                                <h3><span class="number2" style="padding: 7px 15px;">+</span> Dentro de EUA <span style="color:red;">*</span> <br> (USA)</h3>
                                <select name="" class="options united"  data-id-pregunta="60">
                                    <option hidden="" value="">Seleciona un opción (Select an option)</option>
                            ...
                            <div class="qs-general" id="estMex" style="display:none">
                                <h3><span class="number2" style="padding: 7px 15px;">+</span> Dentro de Chihuahua <span style="color:red;">*</span> <br> (Chihuahua)</h3>
                                <select name="" style="width: 100%;" class="options mex"  data-id-pregunta="61">
                                    <option hidden="" value="">Seleciona un opción (Select an option)</option>
                            ...
                            <div class="qs-general" >
                                <h3><span class="number" style="padding: 7px 15px;">3</span> ¿Quiénes conforman el grupo de viaje? <span style="color:red;">*</span><br> (Who makes up the travel group?) </h3>
                                <select name=""  style="width: 100%;" class="options" id="selPerson" data-id-pregunta="63">
                                    <option hidden="" value="">Seleciona un opción (Select an option)</option>
                            ...
                            <div class="qs-general checkRadio" data-id-pregunta="64">
                                <h3><span class="number" style="padding: 7px 15px;">4</span>¿En su experiencia volveria a este lugar turístico?  <span style="color:red;">*</span> <br>(In your experience, would you return to this tourist place?)</h3>
                                <label ><input type="radio" id="" name="cantPerson" value="Si"/>Si (Yes)</label>
                                <label ><input type="radio" id="" name="cantPerson" value="No"/>No </label>
                            </div>

                            <!-- <div class="qs-general">
                                <h3>7.- ¿Le gustaría agregar algo? <br>(Would you like to add something else?) </h3>
                                <div class="text-opts" style="width:100%; width: 100%; height: 45px;"><textarea name="" id="" class="" cols="30" rows="10" style="height: 45px;" data-id-pregunta="58"></textarea></div>
                            </div> -->
...
$(document).ready(function() {
        ...
        inputAct.forEach(function(radio) {
            radio.addEventListener('change', function() {
                ...
                if (this.value === "Si") {
                    $(yesWhat).html('');
                    $(yesWhat).html('<h3>3.- ¿Qué actividades realizó o realizará en este viaje?  <span style="color:red;">*  </span>  <span style="font-family: PublicSans Italic Extra Light; color: #545859;">Se puede marcar más de una opción </span> <br>(What activities did you do or will you do on this trip?<span style="color:red;">*  </span><span style="font-family: PublicSans Italic Extra Light; color: #545859;"> Check all that apply </span>)</h3>'+

                                    '<label ><input type="checkbox" name="actividades" value="Caminatas" id="">Caminatas (Hikes)</label>'+
                                    '<label ><input type="checkbox" name="actividades" value="Recorrido-por-la-zona-arquelógica" id="">Recorrido por la zona arquelógica (Tour of the Archaeological Zone)</label>'+
                                    '<label ><input type="checkbox" name="actividades" value="Visita-a-Mata-Ortíz-y-Colonia Juárez" id="">Visita a Mata Ortíz y Colonia Juárez (Visit to Mata Ortíz and Colonia Juárez)</label>'+
                                    '<label ><input type="checkbox" name="actividades" value="Visita-a-Viñedo" id="">Visita a Viñedo (Visit to vineyard)</label>'+
                                    '<label ><input type="checkbox" name="actividades" value="Talleres-artesanales" id="">Talleres artesanales (Craft workshops)</label>'+
                                    '<label ><input type="checkbox" name="actividades" value="Muestras-gastronómicas" id="">Muestras gastronómicas (Food tastings or cooking workshops)</label>'+
                                    '<label ><input type="checkbox" name="actividades" value="Descenso-a-Rappel" id="">Descenso a Rappel (Rappelling down)</label>'+
                                    '<label ><input type="checkbox" name="actividades" value="Paseos-en-cuatrimotos-y-4x4" id="">Paseos en cuatrimotos y 4x4 (ATVs tours)</label>'+
                                    '<label ><input type="checkbox" name="actividades" value="Observación-de-flora-y-fauna" id="">Observación de flora y fauna (Flora & fauna tours)</label>'+
                                    '<label ><input type="checkbox" name="actividades" value="Callejoneadas" id="">Callejoneadas (Street parties)</label>'+
                                    '<label ><input type="checkbox" name="actividades" value="Actividad-cultural-en-contacto-con-pueblos-originarios" id="">Actividad cultural en contacto con pueblos originarios (Cultural immersion in touchwith indigenous cultures)</label>'+
                                    '<label ><input type="checkbox" name="actividades" value="Medicina-tradicional" id="">Medicina tradicional, temazcal y herbolaria (Traditional & alternative medicine, herbalism, sweat lodge)</label>'+
                                    '<label ><input type="checkbox" name="actividades" value="Conciertos-y-festivales-de-música" id="">Conciertos y festivales de música (Concerts & musical festivals)</label>'+
                                    '<label ><input type="checkbox" name="actividades" value="Ninguna" id="">Ninguna (None)</label>');
                    yesWhat.setAttribute('data-id-pregunta', '54');
                    ...
                    $(yesWhat).html('<h3>3.- ¿Porqué?  <span style="color:red;">*</span><br> (Why?)</h3>'+
                                    ...
                                    '</select>');
                    yesWhat.setAttribute('data-id-pregunta', '55');
                }
            });
        });

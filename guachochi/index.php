    ...
    <head>
        ...
        <style>
            .contLogosImg,  .contLogosImg2{
                background-image: url(../_images/guachochi.jpg);
            }
        </style>
    </head>
            ...
            <div class="cont-questions">
                    ...
                    <div class="part1" style="display:none;">
                        ...
                        <input type="hidden" name="part-enc" class="parteEncuesta" value="1">
                            <input type="hidden" name="municipio" class="municipio" value="4">
                            <!-- <input type="hidden" name="hotel" id="hotel" class="" value=""> -->
                            
                            <div class="qs-general checkRadio" data-id-pregunta="90">
                            ...
                            <div class="qs-general checkbox" data-id-pregunta="103">
                                <h3><span class="number">2</span> ¿Qué transporte utilizó para llegar? <span style="color:red;">*  </span><span style="font-family: 'PublicSans Italic Extra Light'; color: #545859;">Se puede marcar mas de una opción </span>  <br>(What is your reason for travelling?<span style="color:red;">*  </span><span style="font-family: 'PublicSans Italic Extra Light'; color: #545859;"> Check all that apply </span>)</h3>
                            ...
                            <div class="qs-general">
                                ...
                                <select name="" class="options required" data-id-pregunta="102">
                                    <option hidden="" value="">Seleciona un opción (Select an option)</option>
                            ...
                            <div class="qs-general">
                                ...
                                <select name="" class="options required" data-id-pregunta="101">
                                    <option hidden="" value="">Seleciona un opción (Select an option)</option>
                            ...
                            <div class="qs-general checkbox" data-id-pregunta="104">
                            ...
                            <div class="qs-general checkbox" data-id-pregunta="105">
                                ...
                                <label ><input type="checkbox" name="actividades-realizo" value="Paseos-en-kayak-o-lancha" id="">Paseos en kayak o lancha (Kayak or boat ride)</label>
                                <label ><input type="checkbox" name="actividades-realizo" value="Tours-en-avioneta" id="">Tours en avioneta (Plane tour)</label>
                                ...
                                <label ><input type="checkbox" name="actividades-realizo" value="Acuario" id="">Acuario (Aquarium)</label>
                    ...
                    <div class="part2" style="display:none;">     
                        <form class="form-questions" >
                            ...
                            <div class="qs-general">
                                ...
                                <select name="edad" class="options required" data-id-pregunta="91">
                                    <option hidden="" value="">Seleciona un opción (Select an option)</option>
                            ...
                            <div class="qs-general">
                                ...
                                <select name="" class="options required" data-id-pregunta="97">
                                    <option hidden="" value="">Seleciona un opción (Select an option)</option>
                            ...
                            <div class="qs-general">
                                ...
                                <select name="" class="options required" data-id-pregunta="96">
                                    <option hidden="" value="">Seleciona un opción (Select an option)</option>
                            ...
                            <div class="qs-general checkbox" data-id-pregunta="100">
                            ...
                            <div class="qs-general checkbox" data-id-pregunta="106">
                                    ...
                                    <label ><input type="checkbox" name="actividades-quisiese-encontrar" value="Paseos-a-caballo" id="">Paseos a caballo (Horse back rinding tours)</label>
                                    <label ><input type="checkbox" name="actividades-quisiese-encontrar" value="Paseos-en-bicicletas" id="">Paseos en bicicletas (MTB tours)</label>
                            ...
                            <div class="qs-general">
                                <h3><span class="number">6</span> ¿Cómo calificas el servicio al cliente? <span style="color:red;">*</span> <br> (How do you rate customer service?)</h3>
                                <select name="" class="options required" data-id-pregunta="109">
                                    <option hidden="" value="">Seleciona un opción (Select an option)</option>
                    ...
                    <div class="part3" style="display:none;">
                        <form class="form-questions preguntas" >
                            ...
                            <div class="qs-general checkRadio pregunta pregunta-activa" data-preg="1" data-id-pregunta="92">
                            ...
                            <div class="qs-general">
                                ...
                                <select id="inter" name="pais" class="options required" style="display:none;" data-id-pregunta="93">
                                    <option hidden="" value="">Seleciona un opción (Select an option)</option>
                                ...
                                <select  class="mexico" name="pais" class="options required" id="mexico" style="display:none;" data-id-pregunta="110">
                                    <option hidden="" value="">Seleciona un opción (Select an option)</option>
                            ...
                            <div class="qs-general" id="estEU" style="display:none">
                                ...
                                <select name="" class="options united"  data-id-pregunta="94">
                                    <option hidden="" value="">Seleciona un opción (Select an option)</option>
                            ...
                            <div class="qs-general" id="estMex" style="display:none">
                                ...
                                <select name="" style="width: 100%;" class="options mex"  data-id-pregunta="95">
                                    <option hidden="" value="">Seleciona un opción (Select an option)</option>
                            ...
                            <div class="qs-general checkRadio pregunta" data-id-pregunta="98">
                            ...
                            <div class="qs-general pregunta" style="display:none" data-preg="6" id="whyPersonVis">
                                ...
                                <select name=""  style="width: 100%;" class="options" id="selPerson" data-id-pregunta="99">
                                    <option hidden="" value="">Seleciona un opción (Select an option)</option>
                            ...
                            <div class="qs-general checkbox" data-id-pregunta="107">
                            ...
                            <div class="qs-general checkbox" data-id-pregunta="108">

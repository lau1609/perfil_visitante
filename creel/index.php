...
<html lang="es" prefix="og: https://ogp.me/ns#">
    <head>
        ...
        <meta property="og:description" content="Encuesta destinada a crear un perfil de nuestra visitantes de Creel" >
        ...
        <style>
            .contLogosImg,  .contLogosImg2{
                background-image: url(../_images/creel.jpg);
            }
        </style>
    </head>
            ...
            <div class="cont-questions">
                    ...
                    <div class="part1" style="display:none;">
                        ...
                        <input type="hidden" name="part-enc" class="parteEncuesta" value="1">
                            <input type="hidden" name="municipio" class="municipio" value="6">
                            <!-- <input type="hidden" name="hotel" id="hotel" class="" value=""> -->
                            
                            <div class="qs-general checkRadio" data-id-pregunta="115">
                            ...
                            <div class="qs-general checkbox" data-id-pregunta="128">
                                ...
                                <label ><input type="checkbox" name="transporte" value="Tren" id="">Tren (Train)</label>
                            ...
                            <div class="qs-general">
                                ...
                                <select name="" class="options required" data-id-pregunta="127">
                                    <option hidden="" value="">Seleciona un opción (Select an option)</option>
                            ...
                            <div class="qs-general">
                                ...
                                <select name="" class="options required" data-id-pregunta="126">
                                    <option hidden="" value="">Seleciona un opción (Select an option)</option>
                            ...
                            <div class="qs-general checkbox" data-id-pregunta="129">
                                ...
                                <label ><input type="checkbox" name="motivo-del-viaje" value="Estudios" id="">Estudios (Educational)</label>
                            ...
                            <div class="qs-general checkbox" data-id-pregunta="130">
                                ...
                                <label ><input type="checkbox" name="actividades-realizo" value="Paseo-en-vehículo-a-sitios-aledaños" id="">Paseo en vehículo a sitios aledaños (Vehicle ride to nearby sites)</label>
                                <label ><input type="checkbox" name="actividades-realizo" value="Caminatas" id="">Caminatas (Hikes)</label>
                                <label ><input type="checkbox" name="actividades-quisiese-encontrar" value="Observación-sideral" id="">Observación sideral (Sky observation tour) </label>
                                ...
                                <label ><input type="checkbox" name="actividades-realizo" value="Visita-al-Parque-Barrancas" id="">Visita al Parque Barrancas (Visit to Barrancas Park)  </label>
                                <label ><input type="checkbox" name="actividades-realizo" value="Muestras-gastronómicasl" id="">Muestras gastronómicas (Food tastings or cooking workshops)</label>
                                ...
                                <label ><input type="checkbox" name="actividades-realizo" value="Medicina-tradicional" id="">Medicina tradicional (Traditional & alternative medicine)</label>
                    ...
                    <div class="part2" style="display:none;">     
                        <form class="form-questions" >
                            ...
                            <div class="qs-general">
                                ...
                                <select name="edad" class="options required" data-id-pregunta="116">
                                    <option hidden="" value="">Seleciona un opción (Select an option)</option>
                            ...
                            <div class="qs-general">
                                ...
                                <select name="" class="options required" data-id-pregunta="122">
                                    <option hidden="" value="">Seleciona un opción (Select an option)</option>
                                    <option value="Estudiante">Estudiante (Student)</option>
                                    <option value="Empleado">Empleado (a) (Employee)</option>
                                    <option value="Empresario">Empresario (a) (CEO/Manager)</option>
                                    <option value="Jubilado">Jubilado (a) (Retired)</option>
                                    <option value="Servidor-Publico">Servidor (a) público (a) (Public servant)</option>
                                    <option value="Otros">Otros (Other)</option>
                                </select>
                            </div>

                            <div class="qs-general checkRadio pregunta" data-id-pregunta="123">
                            ...
                            <div class="qs-general pregunta" style="display:none"  id="whyPersonVis">
                                ...
                                <select name=""  style="width: 100%;" class="options" id="selPerson" data-id-pregunta="124">
                                    <option hidden="" value="">Seleciona un opción (Select an option)</option>
                            ...
                            <div class="qs-general checkbox" data-id-pregunta="125">
                            ...
                            <div class="qs-general checkbox" data-id-pregunta="131">
                                    <h3><span class="number">5</span> ¿Qué otras actividades le hubiese gustado encontrar? <span style="color:red;">*  </span> <span style="font-family: 'PublicSans Italic Extra Light'; color: #545859;">Se puede marcar mas de una opción </span>  <br>(What activities would you have liked to find?<span style="color:red;">*  </span><span style="font-family: 'PublicSans Italic Extra Light'; color: #545859;"> Check all that apply </span>)</h3>
                                    ...
                                    <label ><input type="checkbox" name="actividades-quisiese-encontrar" value="Observación-de-flora-y-fauna" id="">Observación de flora y fauna (Flora & fauna tours)</label>
                                    
                                    <label ><input type="checkbox" name="actividades-quisiese-encontrar" value="Paseos-teatrales" id="">Paseos teatrales (Theatrical tours) </label>
                                    <label ><input type="checkbox" name="actividades-quisiese-encontrar" value="Recorridos-catas-vino-o-sotol" id="">Recorridos y catas de vino o sotol (Wine tasting & tours)  </label>
                                    ...
                                    <label ><input type="checkbox" name="actividades-quisiese-encontrar" value="Actividad-cultural-con-pueblos-originarios" id="">Actividad cultural con pueblos originarios (Cultural immersion with indigenous cultures) </label>
                                    ...
                                    <label ><input type="checkbox" name="actividades-quisiese-encontrar" value="Comida-típica-chihuahuense" id="">Comida típica chihuahuense (Chihuahua's regional food)</label>
                                    <label ><input type="checkbox" name="actividades-quisiese-encontrar" value="Otros" id="">Otros</label>
                    ...
                    <div class="part3" style="display:none;">
                        <form class="form-questions preguntas" >
                            ...
                            <div class="qs-general checkRadio pregunta pregunta-activa"  data-id-pregunta="117">
                            ...
                            <div class="qs-general">
                                ...
                                <select id="inter" name="pais" class="options required" style="display:none;" data-id-pregunta="118">
                                    <option hidden="" value="">Seleciona un opción (Select an option)</option>
                                ...
                                <select  class="mexico" name="pais" class="options required" id="mexico" style="display:none;" data-id-pregunta="134">
                                    <option hidden="" value="">Seleciona un opción (Select an option)</option>
                            ...
                            <div class="qs-general" id="estEU" style="display:none">
                                ...
                                <select name="" class="options united"  data-id-pregunta="119">
                                    <option hidden="" value="">Seleciona un opción (Select an option)</option>
                            ...
                            <div class="qs-general" id="estMex" style="display:none">
                                ...
                                <select name="" style="width: 100%;" class="options mex"  data-id-pregunta="120">
                                    <option hidden="" value="">Seleciona un opción (Select an option)</option>
                            ...
                            <div class="qs-general">
                                ...
                                <select name="" class="options required" data-id-pregunta="121">
                                    <option hidden="" value="">Seleciona un opción (Select an option)</option>
                            ...
                            <div class="qs-general checkbox" data-id-pregunta="132">
                            ...
                            <div class="qs-general checkbox" data-id-pregunta="133">

...
<html lang="es" prefix="og: https://ogp.me/ns#">
            ...
            <div class="cont-questions">
                    ...
                    <div class="part1" style="display:none;">
                        ...
                        <input type="hidden" name="part-enc" class="parteEncuesta" value="1">
                            ...
                            <div class="qs-general">
                                <h3>7.- ¿Quiénes conforman el grupo de viaje? <span style="color:red;">*</span><br> (Who are you traveling with?) </h3>
                    ...
                    <div class="part2" style="display:none;">     
                        <form class="form-questions" >
                            ...
                            <div class="qs-general">
                                <h3>1.- ¿A qué se dedica? <span style="color:red;">*</span> <br> (What is your actual occupation?)</h3>
                            ...
                            <div class="qs-general">
                                <h3>2.- ¿Con cuántas personas viaja -Sin contarse a usted-?  <span style="color:red;">*</span> <br>(How many people you travelling with?)</h3>
                    ...
                    <div class="part3" style="display:none;">
                        <form class="form-questions" >
                            ...
                            <div class="qs-general checkbox" data-id-pregunta="36">
                                <h3>1.- ¿Qué tipo de transporte se utilizó para llegar a este destino? <span style="color:red;">*  </span><span style="font-family: 'PublicSans Italic Extra Light'; color: #545859;">Se puede marcar mas de una opción</span>  <br>(What type of transportation did you use to get here?) </h3>
                            ...
                            <div class="qs-general">
                                <h3>2.- ¿Realizó o va a realizar alguna actividad recreativa en este viaje? <span style="color:red;">*</span><br> (Did you or will you do any recreational activity in this trip?)</h3>
                            ...
                            <div class="qs-general checkbox" data-id-pregunta="40">
                                <h3>4.- ¿Qué otros elementos le hubiera gustado encontrar en la región? <span style="color:red;">*  </span>  <span style="font-family: 'PublicSans Italic Extra Light'; color: #545859;">Se puede marcar mas de una opción</span> <br>(Which other elements would you have liked to find?) </h3>
                            ...
                            <div class="qs-general checkbox" data-id-pregunta="41">
                                <h3>5.- ¿Qué otras actividades le hubiera gustado encontrar en la región? <span style="color:red;">*  </span>  <span style="font-family: 'PublicSans Italic Extra Light'; color: #545859;">Se puede marcar mas de una opción</span> <br>(Which other activities would you have liked to find?) </h3>
                            ...
                            <div class="qs-general">
                                    <h3>6.- ¿Le gustaría agregar algo? <span style="color:red;">*</span> <br>(Would you like to add something?) </h3>
                                    <div class="text-opts" style="width:100%; width: 100%; height: 45px;"><textarea name="" id="" class="required" cols="30" rows="10" style="height: 45px;" data-id-pregunta="42"></textarea></div>
                                </div>
                            <div class="cont-butt-env"> 
                                <input class="but-env" type="submit" value="Enviar">
                            </div>
    ...
    <script>
	   ...
	   var inputAct = document.querySelector('select[name="MakeAct"]');
        var yesWhat = document.querySelector('.yesWhat');
        // Agregar un evento de cambio al checkbox "Ninguna"
        inputAct.addEventListener('change', function() {
            // Si el checkbox "Ninguna" está seleccionado
            if (this.value == "Si") {

                $(yesWhat).html('');
                $(yesWhat).html('<h3>3.- ¿Que actividades realizo o realizará en este viaje? <span style="color:red;">*  </span>  <span style="font-family: "PublicSans Italic Extra Light"; color: #545859;">Se puede marcar mas de una opción</span> <br>(What activities did or will you do in this trip?) </h3>'+
                                '<label for=""><input type="checkbox" name="actividades" value="Paseos-teatreales" id="">Paseos teatreales (Theatrical tours)</label>'+
                                '<label for=""><input type="checkbox" name="actividades" value="Recorridos-o-talleres-de-vino-o-Sotol" id="">Recorridos o talleres de vino o Sotol (Theatrical tours)</label>'+
                                '<label for=""><input type="checkbox" name="actividades" value="Muestras-gastronomicas" id="">Muestras gastronómicas (Food tastings or cooking workshops)</label>'+
                                '<label for=""><input type="checkbox" name="actividades" value="Conciertos-y-festivales-de-música" id="">Conciertos y festivales de música (Concerts & musical festivals)</label>'+
                ...
                $(yesWhat).html('<h3>3.- ¿Porque?  <span style="color:red;">*</span><br> (Why?)</h3>'+
                                '<select name="" class="options required" data-id-pregunta="39">'+
                                    '<option hidden="" value="">Seleciona un opcion</option>'+
                                    '<option value="Falta-de-tiempo">Por falta de tiempo (Lack of time)</option>'+
                                    '<option value="No-me-interesa">No me interesa (i am not interested)</option>'+
                                    '<option value="No-encontré-nada">No encontré nada (I didnt find anything)</option>'+
                                '</select>');
